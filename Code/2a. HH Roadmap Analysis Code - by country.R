...
for (i in unique(df_long$Country)){
...
ggsave(paste0("Figures/Drafts/Countries/HH 3. surv_phase1_baseline_vs_endline_change_count",i,".png"), plot_surv_change_site_level_phase1, width = 18, height = 8, dpi =300)
ggsave(paste0("Figures/Drafts/Countries/HH 3. surv_phase1_baseline_vs_endline_change_count_ver2_",i,".png"), plot_surv_change_site_level_phase1_ver2, width = 18.4, height = 6.5, dpi =300)
