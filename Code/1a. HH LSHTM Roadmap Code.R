...
df <- read.csv("Data/DHIS2_phase_1_hh_all_data_uploaded_version.csv") # Replace with your DHIS2 HH site tool data .csv filepath
...
write_xlsx(hh_tiers_df, "Data/HH LSHTM Roadmap status uploaded_version.xlsx") ## Modify the output directory as required.
