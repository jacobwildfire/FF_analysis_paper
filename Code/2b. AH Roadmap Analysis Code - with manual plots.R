...
paper_ah_time_plot <- df_surv_phase1_long_col %>%
...
paper_ah_change_plot_v2 <- ggplot() +
  facet_wrap(~`LSHTM subcomponent`,
             labeller = labeller(`LSHTM subcomponent` = custom_labels), nrow = 3) +
...
ggsave(paste0("Figures/Drafts/AH 3. surv_phase1_baseline_vs_endline_change_count",".png"), plot_surv_change_site_level_phase1, width = 14, height = 8, dpi =300)
ggsave(paste0("Figures/Drafts/AH 3. surv_phase1_baseline_vs_endline_change_count_ver2",".png"), plot_surv_change_site_level_phase1_ver2, width = 14, height = 6.5, dpi =300)

## paper
ggsave(paste0("Figures/Drafts/AH 4. surv_phase1_sites_count_time_paper",".png"), paper_ah_time_plot, width = 9, height = 5, dpi =300)
